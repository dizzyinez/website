...
<template>
        <div class="fungi">
                <div>
                        ...
                        <Slider name="Half Saturation constant for W" v-model="params.k_W" :min="0" :max="0.5" :step="0.1" />
                        ...
                        <Slider name="Sensitivity of F death to I" v-model="params.s_F" :min="0" :max="5" :step="0.5" />
                        <Slider name="Fungus diffusion rate" v-model="params.Diff_F" :min="0" :max="0.05" :step="0.01" />
                        <Slider name="Inhibitor diffusion rate" v-model="params.Diff_I" :min="0" :max="0.01" :step="0.001" />
                        <Slider name="Inhibitor Convection rate" v-model="params.Conv_I" :min="0" :max="0.15" :step="0.01" />
